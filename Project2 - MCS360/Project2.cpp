...
int main() {
    List L;
    std::vector<std::string> v = {"chicago", "is", "located", "in", "northeastern", "illinois",
    ...
    std::cout << "-------------------" << std::endl;
    std::cout << L.longest_string() << std::endl;
    std::cout << "-------------------" << std::endl;
    std::cout << L.average_word_length() << std::endl;
    std::cout << "-------------------" << std::endl;
    std::cout << L.build_sentence() << std::endl;
    std::cout << "-------------------" << std::endl;
    L.prioritize_list();
    L.print();
    std::cout << "-------------------" << std::endl;
